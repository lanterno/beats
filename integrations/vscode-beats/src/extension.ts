...
import { type FlowSummary, formatStatusBar, type HealthSummary } from "./statusBar";
...
export function activate(context: vscode.ExtensionContext): void {
	...
	context.subscriptions.push(vscode.commands.registerCommand("beats.openInsights", openInsights));
