...
function PulsingClock() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="w-full h-full">
      ...
      {/* Minute hand */}
      <line x1="32" y1="32" x2="32" y2="16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.4">
        <animateTransform
      ...
      {/* Hour hand */}
      <line x1="32" y1="32" x2="32" y2="22" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.3">
        <animateTransform
          attributeName="transform"
          type="rotate"
          from="0 32 32"
...
function SproutingSeedling() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="w-full h-full">
      {/* Ground line */}
      <line x1="16" y1="52" x2="48" y2="52" stroke="currentColor" strokeWidth="2" opacity="0.2" strokeLinecap="round" />
      {/* Stem */}
      <line x1="32" y1="52" x2="32" y2="28" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.3">
      ...
      {/* Left leaf */}
      <path d="M32 36 C28 32, 22 32, 20 28" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.3">
        <animate attributeName="opacity" values="0;0.3;0" dur="4s" repeatCount="indefinite" />
      </path>
      {/* Right leaf */}
      <path d="M32 32 C36 28, 42 28, 44 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.3">
        <animate attributeName="opacity" values="0;0.3;0" dur="4s" repeatCount="indefinite" begin="0.5s" />
      </path>
    </svg>
  );
}
...
function GrowingChart() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="w-full h-full">
      {/* Base line */}
      <line x1="12" y1="52" x2="52" y2="52" stroke="currentColor" strokeWidth="2" opacity="0.2" strokeLinecap="round" />
      {/* Bars growing upward */}
      {[0, 1, 2, 3, 4].map((i) => {
        const x = 16 + i * 8;
